...
- For `ollama:codex-rescue`, do not turn a failed or incomplete Codex run into a Claude-side implementation attempt. Report the failure and stop.
- For `ollama:codex-rescue`, if Codex was never successfully invoked, do not generate a substitute answer at all.
