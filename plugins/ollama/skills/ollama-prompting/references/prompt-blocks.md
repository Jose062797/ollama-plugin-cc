...
Use these blocks selectively when composing prompts for the local model.
...
Use when the local model should act without asking routine questions.
...
Use when the local model might otherwise guess.
