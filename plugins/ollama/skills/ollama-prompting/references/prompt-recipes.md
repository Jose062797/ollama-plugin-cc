...
Use these as starting templates for Ollama task prompts or other prompts for the local model.
...
```xml
<task>
Diagnose why this existing prompt is underperforming and propose the smallest high-leverage changes to improve it for the local model.
</task>
